...
- **RemoteRegistryStorage**: Fetches image manifests and exposes blob storage for OCI registries
- **Storage/BlobResolver**: Chains blob range reads into chunk-level file access
